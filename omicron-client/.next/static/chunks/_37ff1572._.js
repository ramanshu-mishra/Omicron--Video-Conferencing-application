        ...
        "Page.useEffect": ()=>{
            ...
            peer.ontrack = ({
                "Page.useEffect": (event)=>{
                    if (remoteRef.current) {
                        ...
                        if (!stream.getTracks().find({
                            "Page.useEffect": (t)=>t.id === event.track.id
                        }["Page.useEffect"])) {
            ...
            ws.onmessage = ({
                "Page.useEffect": async (e)=>{
                    ...
                    if (type === __TURBOPACK__imported__module__$5b$project$5d2f$interface$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RequestType"].OFFER) {
...
_s(Page, "vFFsdv1lW7VLJbfG5uLx7RLcDzo=");
_c = Page;
var _c;
...
//# sourceMappingURL=_37ff1572._.js.map